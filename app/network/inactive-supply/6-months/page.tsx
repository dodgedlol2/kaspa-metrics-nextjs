...
export default async function InactiveSupply6MonthsPage() {
  const kaspaGenesis = new Date('2021-11-07T00:00:00.000Z')
  const adjustedGenesis = new Date(kaspaGenesis)
  adjustedGenesis.setMonth(adjustedGenesis.getMonth() + 6)
    ...
    <div className="min-h-screen bg-[#0F0F1A] p-6">
      <div className="mb-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-b from-[#FFFFFF] to-[#A0A0B8] bg-clip-text text-transparent drop-shadow-sm">
          Kaspa Supply Not Moved in 6+ Months
        </h1>
      </div>
      ...
      <div className="bg-[#1A1A2E] border border-[#2D2D45] rounded-lg p-6">
        ...
        <div className="space-y-4 text-[#9CA3AF]">
          <p>
            This chart shows the percentage of Kaspa's total supply that hasn't been moved in over 6 months. 
            A higher percentage indicates strong holder conviction and medium-term accumulation patterns.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
              ...
              <p className="text-sm">
                ...
                This helps identify correlations between price action and changes in medium-term holder behavior.
              </p>
              <p className="text-sm mt-2">
