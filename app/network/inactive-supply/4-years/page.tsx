...
export default async function InactiveSupply4YearsPage() {
  const kaspaGenesis = new Date('2021-11-07T00:00:00.000Z')
  const adjustedGenesis = new Date(kaspaGenesis)
  adjustedGenesis.setFullYear(adjustedGenesis.getFullYear() + 4)
    ...
    <div className="min-h-screen bg-[#0F0F1A] p-6">
      <div className="mb-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-b from-[#FFFFFF] to-[#A0A0B8] bg-clip-text text-transparent drop-shadow-sm">
          Kaspa Supply Not Moved in 4+ Years
        </h1>
      </div>
      ...
      <div className="bg-[#1A1A2E] border border-[#2D2D45] rounded-lg p-6">
        ...
        <div className="space-y-4 text-[#9CA3AF]">
          <p>
            This chart shows the percentage of Kaspa's total supply that hasn't been moved in over 4 years. 
            A higher percentage indicates the strongest possible holder conviction and represents the most committed long-term investors.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
              ...
              <p className="text-sm">
                ...
                This helps identify correlations between price action and changes in the most committed holder behavior.
              </p>
              <p className="text-sm mt-2">
