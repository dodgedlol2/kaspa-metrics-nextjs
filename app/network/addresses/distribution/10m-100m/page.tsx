import { getPriceData, getAddressDistribution10mto100mData } from '@/lib/sheets'
import AddressDistributionChart from '@/components/charts/AddressDistributionChart'

export default async function KAS10mto100mDistributionPage() {
    ...
    <div className="min-h-screen bg-[#0A0A12] text-white">
      <div className="p-6">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-b from-[#FFFFFF] to-[#A0A0B8] bg-clip-text text-transparent drop-shadow-sm">
                Address Distribution: 10M-100M KAS
              </h1>
              <p className="text-[#6B7280] text-lg">
                Analysis of addresses holding between 10,000,000 and 100,000,000 KAS tokens over time
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 text-sm text-[#6B7280] mb-6">
          ...
          <span className="text-[#5B6CFF]">10M-100M KAS</span>
        </div>
        ...
        <div className="mb-8">
          <AddressDistributionChart 
            ...
            priceData={priceData}
            height={650}
            tierName="10M-100M KAS"
            tierRange="10,000,000 to 100,000,000 KAS"
          />
        </div>
      </div>
    </div>
