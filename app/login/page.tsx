    ...
    <div className="min-h-screen bg-gradient-to-br from-kaspa-dark via-kaspa-darker to-kaspa-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to access premium Kaspa analytics</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mb-6">
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center px-4 py-3 border border-white/20 rounded-lg text-white hover:bg-white/10 transition-colors disabled:opacity-50"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-kaspa-dark text-gray-400">Or continue with email</span>
            </div>
          </div>
        ...
        <div className="text-center">
          <p className="text-gray-400 text-sm">
            ...
            <Link href="/register" className="text-kaspa-purple hover:text-kaspa-blue">
              Sign up for free
            </Link>
          </p>
