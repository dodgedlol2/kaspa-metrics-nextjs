...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: '3D PowerLaw',
        href: '/powerlaw/3d-powerlaw',
        icon: (
          <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M3,11H11V3H3M5,5H9V9H5M13,3V11H21V3M19,9H15V5H19M3,21H11V13H3M5,15H9V19H5M13,13V21H21V13M19,19H15V15H19Z"/>
          </svg>
        )
      }
    ]
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            href: '/network/inactive-supply/smart-indicator',
            icon: (
              <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Sidebar() {
  ...
  return (
    <div className="w-60 bg-[#0F0F1A]/80 backdrop-blur-xl border-r border-[#2D2D45]/30 h-full overflow-y-auto">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-[#2D2D45]/30 bg-[#0F0F1A]/90 backdrop-blur-sm">
        <div className="text-center">
          ...
          <div className="flex items-center justify-center mt-1.5 space-x-1">
            ...
            <span className="text-[#9CA3AF] text-[10px]">Live Data</span>
          </div>
        </div>
      </div>
    </div>
